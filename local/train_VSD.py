...
if __name__=="__main__":
    ...
    parser.add_argument("--minibatchsize_dev", default=48, type=int)
    ...
    parser.add_argument("--start_iter", default=5, type=int)
    parser.add_argument("--end_iter", default=15, type=int)
